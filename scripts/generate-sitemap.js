...
// Configuration
const CONFIG = {
  baseUrl: 'https://southwestmichiganroofingandconstructionllc.com/',
  ...
  rules: {
    ...
    '/insurance-claim-support/': { priority: '0.80', changefreq: 'monthly' },
    '/new-construction/': { priority: '0.80', changefreq: 'monthly' },
    '/new-roof/': { priority: '0.80', changefreq: 'monthly' },
    '/quick-booking/': { priority: '0.80', changefreq: 'monthly' },
